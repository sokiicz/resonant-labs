...
window.SITE_DATA = {
  ...
  apps: [
    ...
    },
    {
      id: "sichta",
      name: "Šichta",
      shortDesc: "Hra na sociální dedukci pro partu u jednoho stolu. Bez vypravěče, každý na svém telefonu.",
      tags: ["Web App", "PWA", "Party Game"],
      emoji: "🔧",
      status: "wip",
      image: null,
      gradientFrom: "#E88B45",
      ...
      releaseDate: null,
      updates: [
        { date: "2026-09-20", note: "scaffolded" },
        { date: "2026-09-20", note: "v1 hotová: pravidla, všech 34 obrazovek, online přes Durable Objects, zvuk a haptika. Privátní repo založeno, čeká playtest." },
      ],
