...
window.SITE_DATA = {
  ...
  apps: [
    ...
    },
    {
      id: "rect",
      name: "Rect",
      shortDesc: "A minimalist Shikaku puzzle game. Draw rectangles to fill the grid — every number tells you exactly how many cells its rectangle must cover. Mobile-first, installable, no build step.",
      tags: ["Game", "PWA", "Open Source"],
      emoji: "⬜",
      status: "live",
      image: null,
      gradientFrom: "#f43f5e",
      ...
      updates: [
        ...
        { date: "2026-06-19", note: "PWA (installable + offline), start-over button, timer-on-load, erase-mode fix" },
        { date: "2026-06-22", note: "difficulty overhaul: no value-1 clues, bigger/harder pieces, faster ramp; grids now 5x5->50x50 with zoom/pan; active-time timer (pauses on blur); no auto-advance; per-grid-size stats screen" },
      ],
    ...
    },
    {
      id: "sichta",
      name: "Šichta",
      shortDesc: "A social deduction party game for one table and no narrator. Everyone plays on their own phone, the app deals the roles, runs the phases, and shows each player only what they are allowed to see. Five to twelve players, about forty minutes.",
      tags: ["Web App", "Open Source"],
      emoji: "🔧",
      status: "wip",
      image: null,
      ...
      liveUrl: "https://sichta.sokiicz.workers.dev",
      liveLabel: "Open App",
      detailUrl: "apps/sichta.html",
      releaseDate: null,
      updates: [
        { date: "2026-09-20", note: "Game design written and stress tested: 6000 simulated games plus an exact Bayesian solver to find the ceiling on pure mechanical deduction. Parity win condition dropped, reward menu added.", label: "Design + simulation" },
        { date: "2026-09-20", note: "Rules built as a pure reducer with no interface attached, covered by tests that play whole games. Player view has its own tests asserting no role can leak over the wire.", label: "Rules engine" },
        { date: "2026-09-20", note: "Brand and all 34 screens: tokens as the single source of colour, primitives that enforce the brand rules structurally. Both roles always see an identical screen.", label: "Brand + screens" },
        { date: "2026-09-20", note: "Online play on Cloudflare Durable Objects, one instance per room, running the same reducer as the browser. WebSocket client survives a sleeping phone and reconnects by token.", label: "Online play" },
        { date: "2026-09-20", note: "Sound and haptics generated by oscillators, so they cost nothing to load. Join by link, shared room code alphabet between server and keypad. Waiting on the first real playtest.", label: "v1 complete" },
        { date: "2026-09-20", note: "Whispers rebuilt as private per-player claims: everyone gets their own true sentence, nobody can verify anyone else's, so saboteurs can simply make theirs up. Capped at three distinct truths per shift so information does not grow with table size. Now live and open source.", label: "Live + open source" },
        { date: "2026-09-20", note: "Full audit of the app, then fixes: per-room random seed (roles no longer depended on join order), immunity and darkness now actually apply to the next council, foreman succession, victim proposals visible to the foreman, server-side authorization of every action, server clock with pause and resume, wake lock, phases end early when everyone has submitted, quorum in the council, whisper families that could not leak a proof. History overview, night waiting screen, play again with the same group. 103 tests plus an end-to-end test against the worker.", label: "Audit + fixes" },
      ],
    ...
    },
    {
      id: "emergence",
      name: "Emergence",
      shortDesc: "A generative world engine. You don't paint pixels — you pick a law of nature, set its constants, and watch a lattice of cells work out what that law implies.",
      tags: ["Generative", "Canvas", "Web App"],
      emoji: "🌀",
      status: "wip",
      image: null,
      gradientFrom: "#312e81",
      ...
      releaseDate: null,
      updates: [
        { date: "2026-08-10", note: "scaffolded" },
        { date: "2026-08-10", note: "v1 (milestones 01-03): 9 distinct rule systems, Canvas 2D renderer with trails/bloom/palettes, symmetry as a growth constraint, laboratory UI" },
      ],
      stack: "vite",
      created: "2026-08-10",
      repo: null,
