...
window.SITE_DATA = {
  ...
  apps: [
    ...
    },
    {
      ...
      releaseDate: null,
      updates: [
        { date: '2026-03-17', note: 'Initial build — fullscreen QR clock with quotes, jokes, facts, multi-part stories, secret codes, easter eggs, and optional Google Sheets CSV source.', label: 'v0.1' },
      ],
    },
    {
      id: 'wildround',
